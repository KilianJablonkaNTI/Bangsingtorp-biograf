...
If you would like to play around on the homepage a little bit just clone the repository and spin it up on a local apache server. The xampp, apache and mysql versions used are the following:
